// =============================================================================
// CURATED — ~100 liquid Indian equities + 10 popular MFs, hand-tagged with
// risk tier, logo, and seed price. Always loaded in the JS bundle so the app
// boots offline and the coach has a reliable starter vocabulary.
//
// Prices stored in PAISE (integer math). Realistic late-2025 levels.
// Sectors match NSE classification. Risk tier is a pedagogical simplification,
// NOT an investment grade.
//
// The full ~2,200-row NSE universe lives in universeFull.json (lazy-loaded).
// universeLoader.js merges curated on top of full, so anything in this file
// wins — re-tag here when a hand-curation overrides the auto-classification.
// =============================================================================
...
export const STOCKS = [
  ...
  { symbol: "TCS",        name: "Tata Consultancy Services", sector: "IT Services",   marketCap: "14.8L Cr", price: 257960, pe: 31.2, pb: 14.1, divYield: 1.40, beta: 0.85, risk: "low",  logo: "TCS" },
  ...
  { symbol: "INFY",       name: "Infosys",                   sector: "IT Services",   marketCap: "7.5L Cr",  price: 131260, pe: 28.6, pb: 9.3, divYield: 2.35, beta: 0.91, risk: "low",  logo: "INF" },
  ...
  { symbol: "KOTAKBANK",  name: "Kotak Mahindra Bank",       sector: "Banking",       marketCap: "3.8L Cr",  price: 37920, pe: 18.8, pb: 2.8, divYield: 0.10, beta: 0.93, risk: "low",  logo: "KMB" },
  { symbol: "BAJFINANCE", name: "Bajaj Finance",             sector: "NBFC",          marketCap: "4.6L Cr",  price: 91775, pe: 30.4, pb: 5.7, divYield: 0.50, beta: 1.35, risk: "high", logo: "BJF" },
  ...
  { symbol: "SBILIFE",    name: "SBI Life Insurance",        sector: "Insurance",     marketCap: "1.5L Cr",  price: 198250, pe: 79.2, pb: 9.4, divYield: 0.15, beta: 0.99, risk: "med",  logo: "SBL" },
  ...
  { symbol: "WIPRO",      name: "Wipro",                     sector: "IT Services",   marketCap: "2.6L Cr",  price:  20248, pe: 24.8, pb: 3.5, divYield: 0.20, beta: 0.82, risk: "low",  logo: "WIP" },
  ...
  // Metals & energy
  { symbol: "TATASTEEL",  name: "Tata Steel",                sector: "Metals",        marketCap: "1.9L Cr",  price:  21172, pe: 24.8, pb: 2.1, divYield: 2.30, beta: 1.32, risk: "high", logo: "TSL" },
  { symbol: "JSWSTEEL",   name: "JSW Steel",                 sector: "Metals",        marketCap: "2.3L Cr",  price:  127450, pe: 32.0, pb: 2.9, divYield: 0.80, beta: 1.35, risk: "high", logo: "JSW" },
  { symbol: "HINDALCO",   name: "Hindalco Industries",       sector: "Metals",        marketCap: "1.4L Cr",  price:  101525, pe: 11.9, pb: 1.5, divYield: 0.80, beta: 1.41, risk: "high", logo: "HAL" },
  ...
  // FMCG & Consumer
  { symbol: "NESTLEIND",  name: "Nestlé India",              sector: "FMCG",          marketCap: "2.4L Cr",  price: 128640, pe: 74.5, pb: 67.5, divYield: 1.10, beta: 0.55, risk: "low",  logo: "NES" },
  ...
  { symbol: "DABUR",      name: "Dabur India",               sector: "FMCG",          marketCap: "1.0L Cr",  price:  44170, pe: 53.4, pb: 10.3, divYield: 1.10, beta: 0.58, risk: "low",  logo: "DAB" },
  { symbol: "TITAN",      name: "Titan Company",             sector: "Consumer",      marketCap: "3.1L Cr",  price: 451300, pe: 90.6, pb: 32.5, divYield: 0.30, beta: 1.03, risk: "med",  logo: "TTN" },
  ...
  { symbol: "CIPLA",      name: "Cipla",                     sector: "Pharma",        marketCap: "1.2L Cr",  price: 122950, pe: 27.0, pb: 3.9, divYield: 0.90, beta: 0.66, risk: "low",  logo: "CPL" },
  ...
  { symbol: "ADANIPORTS", name: "Adani Ports & SEZ",         sector: "Infrastructure",marketCap: "2.5L Cr",  price: 157840, pe: 31.2, pb: 4.9, divYield: 0.45, beta: 1.52, risk: "high", logo: "ADP" },
  { symbol: "IRCTC",      name: "IRCTC",                     sector: "Services",      marketCap: "0.6L Cr",  price:  56520, pe: 51.7, pb: 14.3, divYield: 0.95, beta: 0.89, risk: "med",  logo: "IRC" },

  // Additional NIFTY 200 names
  { symbol: "HDFCAMC",    name: "HDFC Asset Management",     sector: "NBFC",          marketCap: "0.8L Cr",  price: 276820, pe: 32.8, pb: 8.5, divYield: 2.20, beta: 0.88, risk: "low",  logo: "HAM" },
  ...
  { symbol: "CHOLAFIN",   name: "Cholamandalam Finance",     sector: "NBFC",          marketCap: "1.0L Cr",  price: 156930, pe: 28.5, pb: 4.4, divYield: 0.15, beta: 1.32, risk: "med",  logo: "CHO" },
  { symbol: "BAJAJFINSV", name: "Bajaj Finserv",             sector: "NBFC",          marketCap: "2.5L Cr",  price: 183060, pe: 35.2, pb: 3.8, divYield: 0.05, beta: 1.28, risk: "med",  logo: "BJV" },
  { symbol: "INDUSINDBK", name: "IndusInd Bank",             sector: "Banking",       marketCap: "1.0L Cr",  price: 85195, pe: 11.5, pb: 1.4, divYield: 1.20, beta: 1.42, risk: "high", logo: "IIB" },
  ...
  { symbol: "FEDERALBNK", name: "Federal Bank",              sector: "Banking",       marketCap: "0.5L Cr",  price:  29435, pe: 8.8, pb: 1.1, divYield: 1.40, beta: 1.18, risk: "med",  logo: "FED" },
  ...
  { symbol: "CANBK",      name: "Canara Bank",               sector: "Banking",       marketCap: "1.0L Cr",  price:  14274, pe: 6.2, pb: 0.9, divYield: 3.10, beta: 1.30, risk: "med",  logo: "CAN" },
  ...
  { symbol: "COLPAL",     name: "Colgate-Palmolive India",   sector: "FMCG",          marketCap: "0.9L Cr",  price: 212900, pe: 50.2, pb: 45.3, divYield: 2.60, beta: 0.58, risk: "low",  logo: "CPL" },
  { symbol: "PGHH",       name: "Procter & Gamble Hygiene",  sector: "FMCG",          marketCap: "0.6L Cr",  price:993300, pe: 80.2, pb: 72.0, divYield: 2.20, beta: 0.50, risk: "low",  logo: "PGH" },
  { symbol: "UBL",        name: "United Breweries",          sector: "FMCG",          marketCap: "0.5L Cr",  price: 152230, pe: 108, pb: 11.8, divYield: 0.30, beta: 0.72, risk: "med",  logo: "UBL" },

  { symbol: "TVSMOTOR",   name: "TVS Motor",                 sector: "Auto",          marketCap: "1.3L Cr",  price: 376190, pe: 48.5, pb: 12.2, divYield: 0.35, beta: 1.12, risk: "med",  logo: "TVS" },
  ...
  { symbol: "ASHOKLEY",   name: "Ashok Leyland",             sector: "Auto",          marketCap: "0.6L Cr",  price:  17596, pe: 24.1, pb: 4.5, divYield: 1.25, beta: 1.30, risk: "med",  logo: "ASH" },
  { symbol: "BOSCHLTD",   name: "Bosch",                     sector: "Auto",          marketCap: "1.0L Cr",  price:3779000, pe: 42.5, pb: 6.8, divYield: 0.75, beta: 0.85, risk: "med",  logo: "BSH" },
  ...
  { symbol: "LUPIN",      name: "Lupin",                     sector: "Pharma",        marketCap: "0.9L Cr",  price: 232870, pe: 38.2, pb: 4.1, divYield: 0.45, beta: 0.74, risk: "med",  logo: "LPN" },
  ...
  { symbol: "TORNTPHARM", name: "Torrent Pharma",            sector: "Pharma",        marketCap: "1.0L Cr",  price: 419120, pe: 65.1, pb: 14.5, divYield: 0.95, beta: 0.65, risk: "low",  logo: "TRP" },
  ...
  { symbol: "AMBUJACEM",  name: "Ambuja Cements",            sector: "Cement",        marketCap: "1.4L Cr",  price:  45490, pe: 52.8, pb: 4.1, divYield: 0.45, beta: 1.05, risk: "med",  logo: "AMB" },
  { symbol: "ACC",        name: "ACC",                       sector: "Cement",        marketCap: "0.4L Cr",  price: 142880, pe: 32.1, pb: 3.2, divYield: 0.95, beta: 1.08, risk: "med",  logo: "ACC" },

  { symbol: "DLF",        name: "DLF",                       sector: "Real Estate",   marketCap: "2.0L Cr",  price:  59640, pe: 65.2, pb: 4.1, divYield: 0.65, beta: 1.28, risk: "med",  logo: "DLF" },
  { symbol: "GODREJPROP", name: "Godrej Properties",         sector: "Real Estate",   marketCap: "0.7L Cr",  price: 175970, pe: 99.5, pb: 5.2, divYield: 0.00, beta: 1.22, risk: "high", logo: "GRP" },
  { symbol: "LODHA",      name: "Macrotech / Lodha",         sector: "Real Estate",   marketCap: "1.3L Cr",  price: 85655, pe: 52.1, pb: 5.5, divYield: 0.15, beta: 1.30, risk: "high", logo: "LDA" },
  ...
  { symbol: "GAIL",       name: "GAIL (India)",              sector: "Energy",        marketCap: "1.3L Cr",  price:  15770, pe: 12.8, pb: 1.5, divYield: 3.50, beta: 0.95, risk: "med",  logo: "GAL" },
  ...
  { symbol: "ADANIGREEN", name: "Adani Green Energy",        sector: "Power",         marketCap: "2.3L Cr",  price: 115270, pe: 225,  pb: 25.0, divYield: 0.00, beta: 1.85, risk: "high", logo: "AGE" },
  { symbol: "ADANIPOWER", name: "Adani Power",               sector: "Power",         marketCap: "2.2L Cr",  price:  20083, pe: 18.5, pb: 4.2, divYield: 0.00, beta: 1.65, risk: "high", logo: "APW" },
  ...
  { symbol: "FORTIS",     name: "Fortis Healthcare",         sector: "Healthcare",    marketCap: "0.5L Cr",  price:  89090, pe: 70.1, pb: 6.2, divYield: 0.25, beta: 0.82, risk: "med",  logo: "FRT" },

  { symbol: "ICICIPRULI", name: "ICICI Prudential Life",     sector: "Insurance",     marketCap: "1.0L Cr",  price:  55790, pe: 82.8, pb: 7.2, divYield: 0.25, beta: 0.95, risk: "med",  logo: "IPL" },
  { symbol: "LICI",       name: "LIC of India",              sector: "Insurance",     marketCap: "7.0L Cr",  price: 82810, pe: 15.5, pb: 6.5, divYield: 0.90, beta: 1.10, risk: "med",  logo: "LIC" },
  ...
  { symbol: "VOLTAS",     name: "Voltas",                    sector: "Consumer Elec", marketCap: "0.6L Cr",  price: 143800, pe: 92.5, pb: 7.5, divYield: 0.25, beta: 1.05, risk: "med",  logo: "VLT" },
  { symbol: "WHIRLPOOL",  name: "Whirlpool of India",        sector: "Consumer Elec", marketCap: "0.2L Cr",  price: 92560, pe: 80.5, pb: 5.8, divYield: 0.30, beta: 0.92, risk: "med",  logo: "WPL" },

  { symbol: "PIDILITIND", name: "Pidilite Industries",       sector: "Chemicals",     marketCap: "1.6L Cr",  price: 139050, pe: 82.5, pb: 19.2, divYield: 0.70, beta: 0.55, risk: "low",  logo: "PID" },
  ...
  { symbol: "MPHASIS",    name: "Mphasis",                   sector: "IT Services",   marketCap: "0.6L Cr",  price: 241700, pe: 30.2, pb: 5.4, divYield: 1.85, beta: 0.90, risk: "low",  logo: "MPH" },
  { symbol: "COFORGE",    name: "Coforge",                   sector: "IT Services",   marketCap: "0.6L Cr",  price: 128810, pe: 50.2, pb: 11.8, divYield: 0.95, beta: 0.95, risk: "med",  logo: "COF" },
  ...
  { symbol: "IRFC",       name: "Indian Railway Finance",    sector: "NBFC",          marketCap: "1.8L Cr",  price:  10302, pe: 25.5, pb: 3.2, divYield: 1.10, beta: 1.35, risk: "med",  logo: "IRF" },
  { symbol: "RECLTD",     name: "REC Limited",               sector: "NBFC",          marketCap: "1.3L Cr",  price:  38270, pe: 8.5, pb: 1.8, divYield: 3.15, beta: 1.30, risk: "med",  logo: "REC" },
  ...
  { symbol: "MOTHERSON",  name: "Samvardhana Motherson",     sector: "Auto",          marketCap: "1.4L Cr",  price:  12319, pe: 35.2, pb: 3.8, divYield: 0.65, beta: 1.32, risk: "med",  logo: "MTH" },
  { symbol: "BHARATFORG", name: "Bharat Forge",              sector: "Auto",          marketCap: "0.6L Cr",  price: 186620, pe: 65.2, pb: 5.5, divYield: 0.65, beta: 1.28, risk: "high", logo: "BHF" },

  { symbol: "BERGEPAINT", name: "Berger Paints",             sector: "Consumer",      marketCap: "0.7L Cr",  price:  48395, pe: 62.5, pb: 14.2, divYield: 0.65, beta: 0.85, risk: "low",  logo: "BRG" },
  ...
  { symbol: "TRENT",      name: "Trent",                     sector: "Retail",        marketCap: "2.5L Cr",  price: 424280, pe: 155, pb: 40.2, divYield: 0.05, beta: 1.00, risk: "high", logo: "TRN" },

  { symbol: "JUBLFOOD",   name: "Jubilant FoodWorks",        sector: "Food",          marketCap: "0.4L Cr",  price:  45615, pe: 105, pb: 14.5, divYield: 0.40, beta: 1.02, risk: "high", logo: "JUB" },
  { symbol: "IEX",        name: "Indian Energy Exchange",    sector: "Exchange",      marketCap: "0.2L Cr",  price:  12499, pe: 48.2, pb: 13.5, divYield: 0.85, beta: 1.08, risk: "med",  logo: "IEX" },

  { symbol: "DIXON",      name: "Dixon Technologies",        sector: "Consumer Elec", marketCap: "0.8L Cr",  price:1121100, pe: 152, pb: 28.5, divYield: 0.05, beta: 1.25, risk: "high", logo: "DXN" },
  { symbol: "POLYCAB",    name: "Polycab India",             sector: "Consumer Elec", marketCap: "0.9L Cr",  price: 819850, pe: 55.2, pb: 10.8, divYield: 0.55, beta: 0.98, risk: "med",  logo: "PLY" },

  { symbol: "TATACOMM",   name: "Tata Communications",       sector: "Telecom",       marketCap: "0.5L Cr",  price: 151570, pe: 92.5, pb: 42.5, divYield: 1.15, beta: 0.92, risk: "med",  logo: "TCO" },
